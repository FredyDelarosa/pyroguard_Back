...
CREATE TABLE Usuarios (
    ...
    rol VARCHAR(50) NOT NULL CHECK (rol IN ('Admin', 'Coordinador', 'Analista', 'Brigadista')),
...
CREATE TABLE Brigadas (
    ...
    nombre VARCHAR(255) NOT NULL,
    id_coordinador UUID REFERENCES Usuarios(id_usuario) ON DELETE SET NULL,
...
-- 3. Tabla de Intervenciones (Asignación a Zonas en ML)
...
-- 4. Tabla de Observaciones de Campo (Por intervención)
...
-- 5. Tabla de Reportes Ciudadanos (Público)
...
-- 6. Tabla de Comunicados Oficiales
